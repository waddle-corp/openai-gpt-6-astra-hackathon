...
export { synthesizeOpportunity } from './synthesize.ts';
export type { ImprovementOpportunity } from './synthesize.ts';
export { FIT_THRESHOLD, isAcceptedTriage, triageFeedback } from './triage.ts';
export type { TriageDecision } from './triage.ts';
