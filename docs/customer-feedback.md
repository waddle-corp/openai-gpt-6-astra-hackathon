...
- Questions: prepared category-specific questions by default; optional Astra-generated questions when credentials are configured. Source is recorded as `prepared` or `astra` and accurately labeled in the UI.
