            ...
            {receipt ? (
              ...
              <>
                <div className="pf-agent-label">
                  ...
                  <span>
                    {busy
                      ...
                      : reply?.source === 'astra'
                        ? 'Astra · shopping assistant'
                        : 'Guided preview'}
                  </span>
                </div>
                {selected.length > 0 && (
                  <div className="pf-context-cards">
                    {selected.map((m) => (
                      <div key={m.id} className="pf-context-card">
                        {m.page.image && <img src={m.page.image} alt="" />}
                        <div>
                  ...
                  <>
                    ...
                    {reply.question ? (
                      ...
                      <div className="pf-conversation-review">
                        <label htmlFor="feedback-summary">Your feedback</label>
                        <textarea
                          id="feedback-summary"
                          value={summary}
                          maxLength={1200}
                ...
                {!busy && reply?.source === 'prepared' && (
                  <p className="pf-footnote">
                    Live AI isn’t connected for this conversation. These prompts
                    are a guided preview.
                  </p>
                )}
              </>
            )}
